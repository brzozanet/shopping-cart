export const createAppbar = ({ cartElement }) => {
  return `
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="#" class="flex items-center">
          🛍️
          <span class="ml-2 self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Flowbite</span>
      </a>
      ...
      <button id="card" data-popover-target="popover-click" data-popover-trigger="click" type="button">🛒</button>
      ${cartElement}
    </div>
  </nav>
  `;
